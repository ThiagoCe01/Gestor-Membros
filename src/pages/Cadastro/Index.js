    ...
    <form className='layoutForm' onSubmit={handleSubmitForm}>
        ...
        <div className="titleSectionForm">
          ...
          <div className="BlocForm">
            ...
            <label className="campForm">
              ...
              <input type="date" name='dateBirth' value={cadMembers.dateBirth || ''}
              onChange={handleSubmitCamps} />
              </label>    
            <label className="campForm">
              <p>Data de batismo</p>
              <input type="date" name='dateBatism' value={cadMembers.dateBatism || ''}
              onChange={handleSubmitCamps}/>
              </label>    
            <label className="campForm">
              <p>Quando se tornou membro do ministério</p>
              <input type="date" name='dateMember' value={cadMembers.dateMember || ''}
              onChange={handleSubmitCamps}/>
              </label>    
            <label className="campForm">
              <p>Qual cargo exerce no ministério</p>
              <input type="text" placeholder='Cargo' name='jobChurch' value={cadMembers.jobChurch || ''} onChange={handleSubmitCamps}  />
              </label>    
            <label className="campForm">
      ...
      <div className="sectionForm">
            ...
            <div className="BlocForm">
              <label className="campForm">
                <p>Facebook</p>
                <input type="url" name="linkFacebook" value={cadMembers.linkFacebook || ''} onChange={handleSubmitCamps}/>
              </label>
              <label className="campForm">
                <p>Instagram</p>
                <input type="url" name="linkInsta" value={cadMembers.linkInsta || ''} onChange={handleSubmitCamps}/>
              </label>
      ...
      <div className="sectionForm">
            ...
            <div className="BlocForm">
              <label className="campForm">
                <p>Anotações</p>
                <textarea name="comentary" placeholder='Descrição' value={cadMembers.comentary || ''} onChange={handleSubmitCamps}>
                  </textarea>
              </label>              
            </div>
      </div>
